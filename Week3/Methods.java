public class Methods {
    ...
    public static void main(String[] args) {
        ...
        //calling a void method that takes a parameter
        int y = 25;
        displayNumber(y);
    ...
    //parameters are containers for values to be passed to
    //the datatype of the value MUST MATCH the data type of the param
