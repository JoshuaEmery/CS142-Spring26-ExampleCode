public class IntroToLogic {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n--- Exercises ---");
        		...
        		//1. create an age variable pick a value for it
		//output you are eligible to vote when age GTE 18
		//output you cannot vote yet otherwise
		int age = 17;
		if(age >= 18) {
		...
		//2. Using x: write a condition that prints in range when
		//x is between 1 and 20. print out of range if not in the range
		
		
		//3. x and y are coordinates on the Cartesian plane write an if check
		//that displays what quadrant the pair lie in - Q1++, Q2-+, Q3--, Q4+-
		//check for x axis y axis and origin
		
		// Exercise 4: Four boolean variables are declared below.
        // Predict what each println will output BEFORE uncommenting it.
        // Write your prediction in the comment above each line, then uncomment to check.
        boolean a = true;
        boolean b = false;
        boolean c = true;
        boolean d = false;
        ...
        // Prediction: ________
        // System.out.println("Ex4a: " + (a && b));

        // Prediction: ________
        // System.out.println("Ex4b: " + (a || b || c));

        // Prediction: ________
        // System.out.println("Ex4c: " + (!a || b && c));

        // Prediction: ________
        // System.out.println("Ex4d: " + (a && !b || c && d));

        // Prediction: ________
        // System.out.println("Ex4e: " + ((!a || b) && (c || !d) || (!b && d)));

        // Exercise 5: Fix the condition so it checks if x is between 1 and 100
        // (currently incorrect)
        if (x > 1 || x < 100) {
            System.out.println("Ex4: x is between 1 and 100 (is this correct?)");
        }

        // Exercise 6: Rewrite using De Morgan's Law
        // !(x > 0 && y > 0)
        if (!(x > 0 && y > 0)) {
            System.out.println("Ex5: At least one is NOT positive");
        }

        // Exercise 7: Write your own condition below
